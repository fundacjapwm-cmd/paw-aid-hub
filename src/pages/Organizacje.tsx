    ...
    <div className="min-h-screen bg-background relative">
      ...
      <main className="relative z-10">
        ...
        <section 
          ...
          style={{
            backgroundImage: `url(${organizationsHero})`,
          ...
          <div className="md:container md:mx-auto md:px-8 px-4 relative z-10">
            ...
            <Breadcrumb className="mb-6">
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage className="text-white">Organizacje</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {filteredOrganizations.map((org) => (
                    <Card 
                      ...
                      className="overflow-hidden bg-card rounded-3xl border-0 shadow-card cursor-pointer animate-fade-in"
                    >
