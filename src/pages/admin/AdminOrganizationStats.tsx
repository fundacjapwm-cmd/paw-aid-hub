...
export default function AdminOrganizationStats() {
  ...
  const topByAnimals = [...stats].sort((a, b) => b.animalsCount - a.animalsCount).slice(0, 10);
  const topByWishlists = [...stats].sort((a, b) => b.wishlistProductsCount - a.wishlistProductsCount).slice(0, 10);
  const topByPurchases = [...stats].sort((a, b) => b.purchasedItemsCount - a.purchasedItemsCount).slice(0, 10);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card>
          <CardHeader>
            <CardTitle>Top 10 - Liczba Zwierząt</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Top 10 - Zapotrzebowanie</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Top 10 - Sprzedaż</CardTitle>
