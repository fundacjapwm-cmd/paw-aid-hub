      ...
      <main>
        ...
        <section className="relative bg-primary py-20 px-4 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 right-1/3 w-6 h-6 bg-white/8 rounded-full animate-float delay-700"></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl text-white/95 mb-8 leading-relaxed font-medium">
                  Poznaj zwierzęta czekające na pomoc. Każde z nich ma swoją historię i marzenia. 🐾
                </p>
              </div>
              ...
              <div className="relative">
                <div className="bg-white/20 backdrop-blur-sm rounded-3xl p-8 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                  <div className="aspect-square bg-white rounded-2xl flex items-center justify-center">
                    <Footprints className="h-20 w-20 text-primary animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto">
              <div className="space-y-2">
                <div className="bg-primary rounded-2xl p-3 w-12 h-12 mx-auto flex items-center justify-center">
                  <Heart className="h-6 w-6 text-white fill-white" />
                </div>
                <p className="text-xl font-bold text-foreground">{allAnimals.length}</p>
                <p className="text-xs text-muted-foreground">Zwierząt do wsparcia</p>
              </div>
              <div className="space-y-2">
                <div className="bg-secondary rounded-2xl p-3 w-12 h-12 mx-auto flex items-center justify-center">
                  <Users className="h-6 w-6 text-white" />
                </div>
                <p className="text-xl font-bold text-foreground">12</p>
                <p className="text-xs text-muted-foreground">Organizacji</p>
              </div>
              <div className="space-y-2">
                <div className="bg-accent rounded-2xl p-3 w-12 h-12 mx-auto flex items-center justify-center">
                  <ShoppingBag className="h-6 w-6 text-white" />
                </div>
                <p className="text-xl font-bold text-foreground">156</p>
                <p className="text-xs text-muted-foreground">Produktów w listach</p>
              </div>
              <div className="space-y-2">
                <div className="bg-primary rounded-2xl p-3 w-12 h-12 mx-auto flex items-center justify-center">
                ...
                <p className="text-xs text-muted-foreground">Średnie wypełnienie</p>
              </div>
            </div>
          </div>
        </section>
