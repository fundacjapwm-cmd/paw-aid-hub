        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                size="lg"
                className="bg-accent text-white hover:bg-accent/90 hover:shadow-[0_0_30px_rgba(233,165,46,0.4)] shadow-card hover:-translate-y-1 transition-all duration-300 rounded-full px-8 h-14 text-lg font-bold hover:scale-105"
