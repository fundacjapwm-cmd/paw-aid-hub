  ...
  return (
    <section className="relative bg-hero py-12 sm:py-16 md:py-20 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-20 h-20 bg-white/15 rounded-full animate-bounce-gentle hidden sm:block"></div>
        <div className="absolute top-32 right-20 w-16 h-16 bg-white/12 rounded-full animate-bounce-gentle delay-1000 hidden md:block"></div>
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-white/10 rounded-full animate-bounce-gentle delay-500 hidden sm:block"></div>
        <div className="absolute top-1/2 left-1/2 w-8 h-8 bg-white/8 rounded-full animate-bounce-gentle delay-700"></div>
        <div className="absolute bottom-10 right-10 w-6 h-6 bg-white/12 rounded-full animate-bounce-gentle delay-200 hidden sm:block"></div>
        <div className="absolute top-20 left-1/3 w-4 h-4 bg-white/15 rounded-full animate-bounce-gentle delay-1200 hidden md:block"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              <Button variant="outline" size="hero" className="border-white text-white hover:bg-white hover:text-primary w-full sm:w-auto">
                Jak to działa?
