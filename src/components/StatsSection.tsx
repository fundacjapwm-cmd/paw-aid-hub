  ...
  return (
    <section className="py-8 px-4 relative z-20 -mt-[72px]">
      <div className="container mx-auto">
        <div className="bg-white/80 backdrop-blur-md rounded-[3rem] shadow-xl p-6 md:p-10 border border-primary/10 max-w-6xl mx-auto">
          <div className="flex flex-col sm:grid sm:grid-cols-2 md:flex md:flex-row md:justify-around md:items-center gap-6 md:gap-0 md:divide-x md:divide-primary/10">
            <StatItem
